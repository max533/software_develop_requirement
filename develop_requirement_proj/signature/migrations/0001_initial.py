# Generated by Django 2.2.13 on 2020-07-27 07:04

import develop_requirement_proj.signature.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.CharField(max_length=50, verbose_name='the owner of the notification')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('develop_team_function', models.CharField(max_length=50, verbose_name="developer's function team")),
                ('develop_team_sub_function', models.CharField(max_length=50, verbose_name="developer's sub function team")),
                ...
                ('repository_url', models.URLField(blank=True, max_length=4000, verbose_name='repository url of source code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sign_unit', models.CharField(max_length=50, verbose_name='the department of signing')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('path', models.FileField(max_length=4000, upload_to=develop_requirement_proj.signature.models.upload_document, verbose_name="document's relative path")),
                ('name', models.TextField(verbose_name="docuemnt's name")),
                ('description', models.TextField(verbose_name="document's description")),
